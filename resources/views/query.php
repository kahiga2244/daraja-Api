...
$CheckoutRequestID = 'ws_CO_12082023092452506721773805';
...
if (isset($data_to->ResultCode)) {
  ...
  if ($ResultCode == '1037') {
    echo "1037 Timeout in completing transaction";
  } elseif ($ResultCode == '2001') {
    echo "1032 Transaction  has cancelled by user";
  } elseif ($ResultCode == '1') {
    echo  "1 The balance is insufficient for the transaction";
  } elseif ($ResultCode == '0') {
    echo "0 The transaction is successfully";
  }
}
